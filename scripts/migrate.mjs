...
const {
  NEXT_PUBLIC_SANITY_PROJECT_ID="enqj5nfc", // Sanity project ID
  NEXT_PUBLIC_SANITY_DATASET="production", // Sanity dataset (e.g., "production")
  NEXT_PUBLIC_SANITY_AUTH_TOKEN="skQ456cK1nyqUP2SHk1l0NUZYuSDDBuFRkAUV43d8TDghXaN7N71kEXjql4jFVkARG4FJ8sjoC0ckf8SHIzmySy562eqYMruhkkbgVVAk11e9H68kj1sV80ZoxdxX4SHgPcGqzsJgZtxTuTQjitd04YOJGn9WzKduHN8rrBFq0Dvrrr2qyfG", // Sanity API token
